...
VALUES
('1','1', 'Собака','Стив', '2022-03-28'),
('2','2', 'Собака','Джек', '2017-08-10'),
('3','3', 'Собака','Жучка', '2010-11-17'),
('4','4', 'Кот','Мурзик', '2021-03-21'),
('5','5', 'Хомяк','Доминик', '2020-01-08'),
('6','6', 'Кошка','Мурка', '2022-03-28');

INSERT INTO Pack_animals (Animal_id, Pack_id,Pack_type, Pack_Name, Pack_Birthdate)
VALUES
('7','1', 'Лошадь','Золотое копыто', '2019-03-14'),
('8','2', 'Конь','Буцифал', '2013-07-10'),
('9','3', 'Верблюд','Тучкудук', '2018-11-23'),
('10','4', 'Осел','Шрек', '2018-01-21');
